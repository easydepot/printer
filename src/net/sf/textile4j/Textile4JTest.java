...
public class Textile4JTest extends TestCase {
    Textile textile = new Textile();


        public void testBug809901() throws Exception {
        String in = "* \"Some Site\":http://www.news.com\n* \"Some Site\":http://www.news.com";
        String out = "\n<ul>\n\t<li><a href=\"http://www.news.com\" title=\"\">Some Site</a></li>\n\t<li><a href=\"http://www.news.com\" title=\"\">Some Site</a></li><br />\n</ul>";
        String content = textile.process(in);
        assertEquals(out,content);
    }
    public void testBug809764() throws Exception {
        String in = "h2. I was here Baby\nsave me";
        String out = "\t<h2>I was here Baby</h2>\n\t<p>save me</p>";
        String content = textile.process(in);
        assertEquals(out,content);
    }
    ...
    public void testLinksSyntax32() {
        String in = "This is a \"link\":http://example.com/index.html.";
        String out = "\t<p>This is a <a href=\"http://example.com/index.html\" title=\"\">link</a>.</p>";
        assertEquals(out, textile.process(in));
    }
    ...
    public void testLinksSyntax47() {
        ...
        String out = "\t<p><a href=\"http://www.xml.com/pub/au/164\" title=\"\">Dive Into XML</a></p>";
        assertEquals(out, textile.process(in));
    }
